...
const DashboardView = ({ insights }) => {
  ...
  const getMarketOutlookInfo = (outlook = "") => {
    switch (outlook.toLowerCase()) {
      ...
      case "negetive": // typo preserved only if your enum is also "NEGETIVE"
    ...
    <div className="space-y-6 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <CardHeader>
          ...
          <CardDescription>Current Trends shaping the indusry </CardDescription>
        </CardHeader>
          ...
          <div className="flex gap-2 flex-wrap">
           {
            insights.recommendedSkills.map((trend,index)=>
             ...
             ( <Badge variant='outline' key={index} className="flex items-start space-x-2">
                <span>{trend}</span>
              </Badge>)
            )
           }
